...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public static final String MSG_ERRO_GENERICA_USUARIO_FINAL =
            "O correu um erro interno inesperado no sistema. " +
    ...
    public ResponseEntity<?> handleExecption(Exception ex, WebRequest request){
    ...
    private ResponseEntity<Object> handleValidationInternal(Exception ex, BindingResult bindingResult,
        ...
        List<Field> problemObjects = bindingResult.getFieldErrors().stream()
                .map(objectError -> {
...
//
//        List<Field> problemFields = bindingResult.getFieldErrors().stream()
//                .map(fieldError -> Field.FieldBuilder.builder()
//                        .name(fieldError.getField())
